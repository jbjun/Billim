...
function ServiceDescriptionPage() {
  ...
  const descriptionType = params.descriptionType;
  if (!descriptionType) return null;
  const Description =
    serviceDescriptionProvider[descriptionType as ServiceDescriptionType];
  return (
    <>
      <Header title="서비스 이용 약관" onBackHistory={handleGoBack} />
      <Description />
    </>
  );
}
...
`),
        ...
        <tr>
          <td colSpan={2}>서비스 이용 시 생성되어 수집되는 정보</td>
          <td
            dangerouslySetInnerHTML={{
              __html: replaceNewlineWithBr(`
              IP주소, 서비스 이용기록,
