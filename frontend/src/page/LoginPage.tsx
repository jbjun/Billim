...
function LoginPage() {
  ...
  return (
    <>
      <Header title="회원가입" onBackHistory={onBackHistory} />
      <Grid container sx={{ p: 2 }} spacing={4} justifyContent="center" alignItems="center">
        <Grid item xs={12}>
          <SpeechBubble />
        </Grid>
        <Grid item xs={12}>
        ...
        <Grid item xs={12}>
          <Button variant="contained" sx={{ width: "100%", backgroundColor: "#7360FF" }}>
            인증번호 확인
          </Button>
        </Grid>
        <Grid item xs={12}>
